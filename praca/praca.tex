...
\begin{enumerate}
  ...
  \item Modyfikowanie sieci drogowej. W tym wypadku zmiany nie zostaną
    ...
    wyników metodyk.
\end{enumerate}
\subsubsection{Integracja z programem \hyperref[r:mopsim]{Mopsim}}
...
\subsubsection{Modele mikro-, mezo-, makroskopowe}
