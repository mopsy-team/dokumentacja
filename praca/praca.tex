...
Użytkownik programu ma możliwość wprowadzeia danych dotyczących \textbf{SDR}
...
powszechny dostęp do internetu, zrezygnowaliśmy z tego rozwiazania, ale warto
...
\begin{enumerate}
  ...
  \item Modyfikowanie sieci drogowej. W tym wypadku zmiany nie zostaną
    ...
    źródła. Możliwe jest jednak wprowadzanie własnych oznaczeń na dodanych
    odcinkach, tak jak na istiejących. 
\end{enumerate}
