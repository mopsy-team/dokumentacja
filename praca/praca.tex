...
\begin{enumerate}
\item Michał Kukuła
\item Przemysław Perkowski - generowanie planów podróży, integracja z \textit{Mopnikiem}
\end{enumerate}
...
\bibitem[10] {metodyki} M. Spławińska, K. Solecka, \\
